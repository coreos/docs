...
Then install as you would with the PXE booted system, but be sure to include login information in a Cloud-Config file, or else you will not be able to log into your CoreOS instance.  
