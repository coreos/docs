...
```sh
curl -L -o cork https://github.com/coreos/mantle/releases/download/v0.8.0/cork-0.8.0-amd64
curl -L -o cork.sig https://github.com/coreos/mantle/releases/download/v0.8.0/cork-0.8.0-amd64.sig
